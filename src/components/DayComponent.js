...
class DayComponent extends Component {
    ...
    var calendarEvents = this.props.store.events[this.props.day.year][this.props.day.month][this.props.day.date].map((obj, index)=> {
        return <button className="event-button" onClick={(e)=> this.props.store.addEvent(e, new Date(this.props.day.year, this.props.day.month, this.props.day.date), 'edit', index)}>{obj.eventName}</button>;
     });
    }
